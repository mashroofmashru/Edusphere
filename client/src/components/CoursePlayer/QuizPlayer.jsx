            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 mb-6">
                ...
                <div className="space-y-3">
                    {question.options.map((option, idx) => (
                        ...
                        >
                            <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${answers[currentQuestion] === idx ? 'border-blue-600' : 'border-gray-400'}`}>
                                {answers[currentQuestion] === idx && <div className="w-3 h-3 bg-blue-600 rounded-full"></div>}
                            </div>
                            <span>{option}</span>
                        </div>
                    ))}
