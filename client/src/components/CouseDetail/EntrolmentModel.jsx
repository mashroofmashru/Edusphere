            ...
            <div className={dialogClasses} role="dialog" aria-modal="true" aria-labelledby="modal-title">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <button type="submit" disabled={isLoading}
                            className={`bg-green-600 w-full font-semibold py-3 rounded-lg shadow-md transition duration-300 ${
                                isLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-deep-blue hover:bg-text-dark transform hover:scale-[1.005]'
                            } text-white`}>
